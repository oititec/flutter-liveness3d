...
# Oiti - Liveness 3D para Flutter

Neste repositório, encontramos a **biblioteca pub.dev do Liveness 3D da Oiti**.
...
- As novidades das versões podem ser acessadas [neste link](https://pub.dev/packages/oiti_liveness3d/versions).
