              ...
              child: Scaffold(
                ...
                body: Column(
                  children: [
                    ...
                    Image.asset(
                      'packages/oiti_liveness3d/lib/assets/images/img_face.png',
                      height: 270.sp,
                      fit: BoxFit.cover,
                    ),
                    Expanded(
                          ...
                          children: [
                            ...
                            const Expanded(
                              ...
                              child: Column(
                                ...
                                children: [
                                  InfoCardWidget(
                                    'packages/oiti_liveness3d/lib/assets/images/lightbulb_outline.png',
                                    'Escolha um ambiente bem iluminado.',
                                  ),
                                  InfoCardWidget(
                                    'packages/oiti_liveness3d/lib/assets/images/face.png',
      ...
      children: [
        Expanded(
          child: Column(
            ...
            children: [
              Image.asset(
                'packages/oiti_liveness3d/lib/assets/images/left-arrow.png',
                height: 22,
                fit: BoxFit.cover,
              ),
            ],
